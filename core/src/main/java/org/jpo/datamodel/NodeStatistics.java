...
public class NodeStatistics {
    ...
    public String getNumberOfNodesString() {
        return JpoCoreResources.getResource("CollectionNodeCountLabel") + getNumberOfNodes();
    }
    ...
    public String getNumberOfGroupsString() {
        return JpoCoreResources.getResource("CollectionGroupCountLabel") + getNumberOfGroups();
    }
    ...
    public String getNumberOfPicturesString() {
        return JpoCoreResources.getResource("CollectionPictureCountLabel") + getNumberOfPictures();
    }
    ...
    public String getSizeOfPicturesString() {
        return JpoCoreResources.getResource("CollectionSizeJLabel") + FileUtils.byteCountToDisplaySize( getSizeOfPictures());
    }
