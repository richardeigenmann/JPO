 ...
 */
public class JpoCoreResources_zh_TW extends ListResourceBundle {
    @Override
    ...
    protected static final Object[][] contents = {
            ...
            // Help About Dialog
            {"HelpAboutText", "JPO 版本 " + GeneratedVersion.JPO_VERSION + " 是基于Java/Swing 開發的軟件\n"
                    + "作者Richard Eigenmann在瑞士蘇黎世, \n"
                    + "版權 2000 - 2025\n"
                    + "郵件地址：richard.eigenmann@gmail.com\n"
                    + "軟件主頁网址：https://j-po.sourceforge.io\n"
            ...
            {"org.jpo.export.GenerateWebsiteWizard3Midres.generateMouseoverJCheckBox", "生成鼠標移動效果"},
            ...
            {"org.jpo.gui.ReconcileFound", "%s 在圖片集中監測到的文件\n"},
