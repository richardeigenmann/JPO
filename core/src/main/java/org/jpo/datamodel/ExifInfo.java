...
public class ExifInfo {
    ...
    public String getComprehensivePhotographicSummary() {
        ...
        // Whether it's N or S
        String latitudeRef = "";
        return JpoCoreResources.getResource("ExifInfoCamera") + "\t" + camera + "\n"
                + JpoCoreResources.getResource("ExifInfoLens") + "\t" + lens + "\n"
                + JpoCoreResources.getResource("ExifInfoShutterSpeed") + "\t" + shutterSpeed + "\n"
                + JpoCoreResources.getResource("ExifInfoAperture") + "\t" + aperture + "\n"
                + JpoCoreResources.getResource("ExifInfoFocalLength") + "\t" + focalLength + "\n"
                + JpoCoreResources.getResource("ExifInfoISO") + "\t" + iso + "\n"
                + JpoCoreResources.getResource("ExifInfoTimeStamp") + "\t" + getCreateDateTime() + "\n"
                + JpoCoreResources.getResource("ExifInfoLatitude") + "\t" + latitude + " " + latitudeRef + "\n"
                + JpoCoreResources.getResource("ExifInfoLongitude") + "\t" + longitude + " " + longitudeRef + "\n";
    }
