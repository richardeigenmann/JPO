 ...
 */
public class JpoCoreResources_en extends ListResourceBundle {
    ...
    protected static final Object[][] contents = {
            ...
            // Help About Dialog
            {"HelpAboutText", "JPO Version " + GeneratedVersion.JPO_VERSION + " is a Java/Swing program\n"
            ...
            {"org.jpo.export.GenerateWebsiteWizard3Midres.generateMouseoverJCheckBox", "Generate mouseover effects"},
            ...
            {"org.jpo.gui.ReconcileFound", "%s found in collection.\n"},
