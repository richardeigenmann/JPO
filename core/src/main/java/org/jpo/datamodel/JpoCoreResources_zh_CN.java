...
/*
Copyright (C) 2002-2026 Richard Eigenmann, Zurich, Switzerland
 ...
 */
public class JpoCoreResources_zh_CN extends ListResourceBundle {
    @Override
...
M: 弹出菜单"""},
            ...
            {"thumbnailShowFilenamesJCheckBox", "在面板中显示文件名"},
            {"thumbnailShowTimestampsJCheckBox", "在缩略图中显示时间戳"},
            ...
            {"generateRobotsJCheckBox", "防止搜索引擎编入索引（写robots.txt）"},
            {"welcomeTitle", "欢迎"}, // new
            ...
            {"org.jpo.gui.ReconcileFound", "%s 在图片集中监测到的文件\n"},
            ...
            {"groupSelectForEmail", "全部选择电子邮件"},
            {"groupExportHtmlMenuText", "生成网站"},
            ...
            {"FileRenameTargetExistsText", "文件％s存在并将被覆盖\n可以更改为％s吗？"},
            ...
            {"FindDuplicatesJMenuItem", "查找重复项"},
            {"EditCategoriesJMenuItem", "类目"},
            {"EditSettingsMenuItemText", "设置..."},
            {"actionJMenu", "工具"},
            {"emailJMenuItem", "发送邮件"},
            {"RandomSlideshowJMenuItem", "随机幻灯片放映"},
            {"StartThumbnailCreationThreadJMenuItem", "启动其他缩略图创建者主题"},
            {"HelpJMenuText", "帮助"},
            ...
            {"checkDateParsing", "检查日期格式"},
            {"check1done", "日期格式不正确"},
            {"checkChecksums", "校检和检验"},
            ...
            {"categoryJLabel", "类目"},
            {"categoriesJLabel", "类目"},
            {"addCategoryJButton", "添加类目"},
            {"deleteCategoryJButton", "删除类目"},
            {"renameCategoryJButton", "重命名类目"},
            {"doneJButton", "完成"},
            ...
            {"numberOfPicturesJLabel", "图片被选中 %d"},
            {"updateJButton", "更新"},
            {"refreshJButtonCUJF", "刷新"},
            {"modifyCategoryJButton", "类目"},
            {"cancelJButton", "取消"},
            ...
            {"PrivacyAll", "All"},
            {"PrivacyClear", "clear"},
            {"PrivacyTumbProgBarTitle", "删除缩略图"},
            {"PrivacyTumbProgBarDone", "％d缩略图已删除"},

            {"org.jpo.dataModel.XmlReader.loadProgressGuiTitle", "装载文件"},
