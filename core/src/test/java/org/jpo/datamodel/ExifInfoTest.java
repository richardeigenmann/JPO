...
/*
 Copyright (C) 2013-2026 Richard Eigenmann.
...
class ExifInfoTest {
    ...
    void testExifInfoD100() {
        ...
        try {
            var exifInfo = new ExifInfo(copyResourceToTempFile(NIKON_D100_IMAGE));
            exifInfo.decodeExifTags();
    ...
    void testExifInfoS4() {
        ...
        try {
            var exifInfo = new ExifInfo(copyResourceToTempFile(SAMSUNG_S4_IMAGE));
            exifInfo.decodeExifTags();
    ...
    void testExifInfoS4Loc() {
        ...
        try {
            var exifInfo = new ExifInfo(copyResourceToTempFile(SAMSUNG_S4_LOC_IMAGE));
            exifInfo.decodeExifTags();
            assertEquals( "f/2.2", exifInfo.getAperture());
            assertEquals("GT-I9505", exifInfo.getCamera());
    ...
    void testExifInfoS4Rot0() {
        ...
        try {
            var exifInfo = new ExifInfo(copyResourceToTempFile(SAMSUNG_S4_ROT0_IMAGE));
            exifInfo.decodeExifTags();
            assertEquals("", exifInfo.getAperture());
            assertEquals("GT-I9505", exifInfo.getCamera());
    ...
    void testExifInfoS4RotLeft() {
        ...
        try {
            var exifInfo = new ExifInfo(copyResourceToTempFile(SAMSUNG_S4_ROT_LEFT_IMAGE));
            exifInfo.decodeExifTags();
            assertEquals("", exifInfo.getAperture());
            assertEquals("GT-I9505", exifInfo.getCamera());
    ...
    void testExifInfoS4RotRight() {
        ...
        try {
            var exifInfo = new ExifInfo(copyResourceToTempFile(SAMSUNG_S4_ROT_RIGHT_IMAGE));
            exifInfo.decodeExifTags();
            assertEquals("", exifInfo.getAperture());
            assertEquals("GT-I9505", exifInfo.getCamera());
    ...
    void testExifInfoS4RotUpsideDown() {
        ...
        try {
            var exifInfo = new ExifInfo(copyResourceToTempFile(SAMSUNG_S4_ROT_UPSIDEDOWN_IMAGE));
            exifInfo.decodeExifTags();
            assertEquals("", exifInfo.getAperture());
            assertEquals("GT-I9505", exifInfo.getCamera());
    ...
    void testExifInfoEos350d() {
        ...
        try {
            final var exifInfo = new ExifInfo(copyResourceToTempFile(CANON_EOS350D_IMAGE));
            exifInfo.decodeExifTags();
    ...
    void testExifInfoCanonEos60D() {
        ...
        try {
            var exifInfo = new ExifInfo(copyResourceToTempFile(CANON_EOS60D_IMAGE));
            exifInfo.decodeExifTags();
    ...
    void testExifInfoCybershot1() {
        ...
        try {
            var exifInfo = new ExifInfo(copyResourceToTempFile(CANON_CYBERSHOT1_IMAGE));
            exifInfo.decodeExifTags();
    ...
    void testExifInfoSonyD700() {
        ...
        try {
            var exifInfo = new ExifInfo(copyResourceToTempFile(SONY_D700_IMAGE));
            exifInfo.decodeExifTags();
    ...
    void testExifInfoSonyP200() {
        ...
        try {
            var exifInfo = new ExifInfo(copyResourceToTempFile(SONY_P200_IMAGE));
            exifInfo.decodeExifTags();
