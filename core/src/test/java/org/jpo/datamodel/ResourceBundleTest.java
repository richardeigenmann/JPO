...
class ResourceBundleTest {
    ...
    void setUp() {
        try {
            jpoResources1 = ResourceBundle.getBundle("org.jpo.datamodel.JpoCoreResources", Locale.ENGLISH);
            jpoResources2 = ResourceBundle.getBundle("org.jpo.datamodel.JpoCoreResources", Locale.GERMAN);
            jpoResources3 = ResourceBundle.getBundle("org.jpo.datamodel.JpoCoreResources", Locale.SIMPLIFIED_CHINESE);
            jpoResources4 = ResourceBundle.getBundle("org.jpo.datamodel.JpoCoreResources", Locale.TRADITIONAL_CHINESE);
    ...
    void testChangeLocale() {
        assertEquals("New Collection", jpoResources1.getString("FileNewJMenuItem"));
        jpoResources1 = ResourceBundle.getBundle("org.jpo.datamodel.JpoCoreResources", Locale.GERMAN);
