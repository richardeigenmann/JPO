...
class PictureInfoTest {
    ...
    void calculateSha256() throws IOException {
        ...
        final var pictureInfo = new PictureInfo(imageFile, "Picture");
    ...
    @Test
    void getSetSha256() throws IOException {
        final var imageFile = Tools.copyResourceToTempFile("/exif-test-canon-eos-350d.jpg");
        final var pictureInfo = new PictureInfo(imageFile, "Sample Picture");
        final var node = new SortableDefaultMutableTreeNode(pictureInfo);
        final var pictureCollection = new PictureCollection();
        pictureCollection.getRootNode().add(node);
    ...
    @Test
    void getSetFileHashGoodToBadFile() throws IOException {
        final var imageFile = Tools.copyResourceToTempFile("/exif-test-canon-eos-350d.jpg");
        final var pictureInfo = new PictureInfo(imageFile, "Sample Picture");
        final var node = new SortableDefaultMutableTreeNode(pictureInfo);
        final var pictureCollection = new PictureCollection();
    ...
    void dateFunctions() {
        final var pictureInfo = new PictureInfo();
        //Settings.setLocale(Locale.ENGLISH);  // TODO removed for split
