...
public class TableJFrame extends JFrame {
     ...
     */
    private static Logger logger = Logger.getLogger( TableJFrame.class.getName() );
            ...
            if ( userObject instanceof PictureInfo ) {
                switch ( col ) {
                    ...
                    case 8:
                        ...
                        break;
                    default:
                        logger.info( "TableDemo.java invoked setValueAt on PictureInfo with bad column: " + Integer.toString( col ) );
                        break;
                }
            } else {
                // GroupInfo
                switch ( col ) {
                    case 1:
                        ...
                        break;
                    default:
                        logger.info( "TableDemo.java invoked setValueAt on GroupInfo with bad column: " + Integer.toString( col ) );
                        break;
                }
            }
