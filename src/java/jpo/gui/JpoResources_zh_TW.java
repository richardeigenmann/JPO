...
public class JpoResources_zh_TW extends ListResourceBundle {
	...
	protected static final Object[][] contents = {
		...
		// Help About Dialog
		{"HelpAboutText", "JPO 版本 0.12 是基于Java/Swing 開發的軟件\n" 
		...
		// HtmlDistillerJFrame
		{"HtmlDistillerJFrameHeading", "以HTML格式導出"}, // ToDo: change to Generate Website
		...
		{"groupExportHtmlMenuText", "導出成HTML"}, // ToDo: Change to "Generate Website"
