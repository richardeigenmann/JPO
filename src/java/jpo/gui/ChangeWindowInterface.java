...
/*
ChangeWindowInterface.java:  defines what a caller of the ChangeWindowPopupMenu must be able to do.
...
public interface ChangeWindowInterface {
	 ...
	 *  @param 	newDecorations	True if the decorations must be changed, 
	 *				false if not
	 */
