...
// End of GUI Widgets
    ...
    public boolean requestNextPicture() {
        if (mySetOfNodes == null) {
            logger.fine("PictureViewer.requestNextPicture: using non context aware step forward");
            ...
            logger.fine("PictureViewer.requestNextPicture: using the context aware step forward. The browser contains: " + Integer.toString(mySetOfNodes.getNumberOfNodes()) + " pictures");
