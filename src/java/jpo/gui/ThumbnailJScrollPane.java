...
public class ThumbnailJScrollPane implements RelayoutListener {
    ...
    private void initComponents() {
        ...
        myScrollPane.setMinimumSize( Settings.thumbnailJScrollPaneMinimumSize );
        myScrollPane.setPreferredSize( Settings.thumbnailJScrollPanePreferredSize );

        myScrollPane.setViewportView( ThumbnailPane );
        ...
        myScrollPane.getVerticalScrollBar().setUnitIncrement( 80 );
        ...
        myScrollPane.setColumnHeaderView( titleJPanel );

        JPanel whiteArea = new JPanel();
        myScrollPane.setCorner( JScrollPane.UPPER_RIGHT_CORNER, whiteArea );
        ...
        ThumbnailPane.addMouseListener( new MouseInputAdapter() {
            ...
            public void mouseReleased( MouseEvent e ) {
                myScrollPane.requestFocusInWindow();
