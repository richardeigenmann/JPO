...
public class PicturePopupMenu
    ...
    /**
     *  array of menu items that allows the user to copy pictures to a recently used zip file
     *
     **/
    private JMenuItem[] memorizedZipFileJMenuItems = new JMenuItem[Settings.MAX_MEMORISE];
    /**
