...
public class ScreenHelper {
    ...
    public static Rectangle getLeftScreenBounds() {
        if ( isXinerama() ) {
            ...
            if ( getNumberOfScreenDevices() > 1 ) {
                ...
                return new Rectangle( bounds.x, bounds.y, (int) ( bounds.width / 2) , bounds.height );
            }
        }
    }
    ...
    public static Rectangle getRightScreenBounds() {
        if ( isXinerama() ) {
            ...
            if ( getNumberOfScreenDevices() > 1 ) {
                ...
                Rectangle bounds = getPrimaryScreen().getBounds();
                return new Rectangle( bounds.x + (int) ( bounds.width / 2), bounds.y, (int) ( bounds.width / 2) , bounds.height );
            }
        }
    }
     ...
     */
    public static void explainGraphicsEnvironmentInLog() {
        if ( Settings.writeLog ) {
            StringBuffer b = explainGraphicsEnvironment();
            sbadd( b.toString() );
        }
    }
    ...
    public static void explainDisplayMode( String id, DisplayMode dm ) {
        sbadd( "DisplayMode for Device: " + id
    ...
    public static void explainGraphicsConfiguration( String id, GraphicsConfiguration gc ) {
        ...
        sbadd( "Graphicsconfiguration for Device: " + id
