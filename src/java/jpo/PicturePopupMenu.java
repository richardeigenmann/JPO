...
public class PicturePopupMenu extends JPopupMenu
     ...
     */
    private JMenu userFunctionsJMenu = new JMenu(Settings.jpoResources.getString("userFunctionsJMenu"));
    /**
     ...
     */
    private JMenu rotationJMenu = new JMenu(Settings.jpoResources.getString("rotation"));
    /**
     *  menu item that allows the user to request regeneration of the
     *  thumbnail with a 90 Deg rotation.
     *
     **/
    private JMenuItem rotate90JMenuItem = new JMenuItem(Settings.jpoResources.getString("rotate90"));
    ;
    /**
     *  menu item that allows the user to request regeneration of the
     ...
     *
     **/
    private JMenuItem rotate180JMenuItem = new JMenuItem(Settings.jpoResources.getString("rotate180"));
    ;
    /**
     *  menu item that allows the user to request regeneration of the
     ...
     *
     **/
    private JMenuItem rotate270JMenuItem = new JMenuItem(Settings.jpoResources.getString("rotate270"));
    ;
    /**
     *  menu item that allows the user to request regeneration of the
     ...
     *
     **/
    private JMenuItem rotate0JMenuItem = new JMenuItem(Settings.jpoResources.getString("rotate0"));
    ;
    /**
     *  menu item that allows the user to remove the picture node from the collection
     **/
    private JMenuItem pictureNodeRemove = new JMenuItem(Settings.jpoResources.getString("pictureNodeRemove"));
    /**
     *  submenu which presents the user with several copy targets
     */
    private JMenu copyImageJMenu = new JMenu(Settings.jpoResources.getString("copyImageJMenuLabel"));
    /**
     *  menu item that presents the user with file chooser for the picture copy
     *
     **/
    private JMenuItem copyToNewLocationJMenuItem = new JMenuItem(Settings.jpoResources.getString("copyToNewLocationJMenuItem"));
    /**
     ...
     */
    private JMenu movePictureNodeJMenu = new JMenu(Settings.jpoResources.getString("moveNodeJMenuLabel"));
    /**
     *  menu item that allows the user to move the current node to the the first position of the owning group
     *
     **/
    private JMenuItem movePictureToTopJMenuItem = new JMenuItem(Settings.jpoResources.getString("movePictureToTopJMenuItem"));
    /**
     *  menu item that allows the user to move the current node up one position
     *
     **/
    private JMenuItem movePictureUpJMenuItem = new JMenuItem(Settings.jpoResources.getString("movePictureUpJMenuItem"));
    /**
     *  menu item that allows the user to move the current node down one position
     *
     **/
    private JMenuItem movePictureDownJMenuItem = new JMenuItem(Settings.jpoResources.getString("movePictureDownJMenuItem"));
    /**
     *  menu item that allows the user to move the current node to the the last position of the owning group
     *
     **/
    private JMenuItem movePictureToBottomJMenuItem = new JMenuItem(Settings.jpoResources.getString("movePictureToBottomJMenuItem"));
    /**
     ...
     */
    private JMenu fileOperationsJMenu = new JMenu(Settings.jpoResources.getString("FileOperations"));
    /**
     *  menu item that allows the user to rename the file on the disk
     *
     **/
    private JMenuItem fileRenameJMenuItem = new JMenuItem(Settings.jpoResources.getString("fileRenameJMenuItem"));
    /**
     *  menu item that allows the image file to be deleted
     *
     **/
    private JMenuItem fileDeleteJMenuItem = new JMenuItem(Settings.jpoResources.getString("fileDeleteJMenuItem"));
    /**
