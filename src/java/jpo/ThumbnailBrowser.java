...
public abstract class ThumbnailBrowser implements ThumbnailBrowserInterface, TreeModelListener {
     ...
     *  Observer pattern.
     */
    private ArrayList relayoutListeners = new ArrayList();
    ...
    /**
     *   Does nothing but can be overriden.
     */
