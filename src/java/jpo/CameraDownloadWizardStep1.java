...
public class CameraDownloadWizardStep1 extends AbstractStep {
    ...
    protected JComponent createComponent() {
        ...
        stepComponent.add( new JLabel( Settings.jpoResources.getString( "DownloadCameraWizardStep1Text1")
        + dataModel.getCamera().getDescription()
        + Settings.jpoResources.getString( "DownloadCameraWizardStep1Text2") ) );
        ...
        Thread t = new SearchForPicturesThread( analysisLabel );
        t.start();
    ...
    /**
     *  This inline class will search for the new pictures. It is implemented as a thread.
     ...
     */
    class SearchForPicturesThread extends Thread {
        ...
        public void run() {
            Tools.log( getClass().toString() + ".run: searching for the new pictures on the camera "
                    + dataModel.getCamera().getDescription() );
            dataModel.setNewPictures( dataModel.getCamera().getNewPictures() );
            progressJLabel.setText( Integer.toString( dataModel.getNewPictures().size() )
            + Settings.jpoResources.getString("DownloadCameraWizardStep1Text3") );
