...
public class CollectionJTree extends JTree {
    public CollectionJTree() {
        ...
        DefaultTreeCellRenderer renderer = new DefaultTreeCellRenderer() {
             ...
             *  {@link #pictureIcon} depending on what sort of userObject
        ...
        TreeCellEditor cellEditor = new DefaultCellEditor( new JTextField() );
        TreeCellEditor treeCellEditor = new DefaultTreeCellEditor( this, renderer, cellEditor ) {
            /**
