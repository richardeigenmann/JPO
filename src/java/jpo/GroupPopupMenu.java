...
class GroupPopupMenu extends JPopupMenu
        ...
        RecentDropNodeListener, RecentFilesChangeListener {
     ...
     **/
    private JMenuItem groupRemove = new JMenuItem( Settings.jpoResources.getString( "groupRemoveLabel" ) );
    /**
     *  menu item that allows the user to export the group to several different formats
     **/
    private JMenuItem groupExportHtml = new JMenuItem( Settings.jpoResources.getString( "groupExportHtmlMenuText" ) );
    /**
     *  menu item that allows the user to export the group to several different formats
     **/
    private JMenuItem groupExportNewCollection = new JMenuItem( Settings.jpoResources.getString( "groupExportNewCollectionMenuText" ) );
    /**
     *  menu item that allows the user to export the group to a flat list of filenames
     **/
    private JMenuItem groupExportFlatFile = new JMenuItem( Settings.jpoResources.getString( "groupExportFlatFileMenuText" ) );
    /**
     *  menu item that allows the user to export the group to several different formats
     **/
    private JMenuItem groupExportJar = new JMenuItem( Settings.jpoResources.getString( "groupExportJarMenuText" ) );
    /**
     *  submenu which has several navigation options
     */
    private JMenu addGroupJMenu = new JMenu( Settings.jpoResources.getString( "addGroupJMenuLabel" ) );
    /**
     *  menu item that allows adding a new blank group
     *
     **/
    private JMenuItem addNewGroupJMenuItem = new JMenuItem( Settings.jpoResources.getString( "addNewGroupJMenuItemLabel" ) );
    /**
     *  menu item that allows adding indivudual pictures
     *
     **/
    private JMenuItem addPicturesJMenuItem = new JMenuItem( Settings.jpoResources.getString( "addPicturesJMenuItemLabel" ) );
    /**
     *  submenu which offers the choice of either loading from a file or from one of the recent collections
     */
    private JMenu addCollectionJMenu = new JMenu( Settings.jpoResources.getString( "addCollectionJMenuItemLabel" ) );
    /**
     ...
     *
     **/
    private JMenuItem addCollectionFormFile = new JMenuItem( Settings.jpoResources.getString( "addCollectionFormFile" ) );
    /**
     *  menu item that allows adding from a list of filenames
     *
     **/
    private JMenuItem addFlatFileJMenuItem = new JMenuItem( Settings.jpoResources.getString( "addFlatFileJMenuItemLabel" ) );
    /**
     *  submenu which has several navigation options
     */
    private JMenu moveGroupNodeJMenu = new JMenu( Settings.jpoResources.getString( "moveNodeJMenuLabel" ) );
    /**
     *  menu item that allows move to top op list
     *
     **/
    private JMenuItem moveGroupToTopJMenuItem = new JMenuItem( Settings.jpoResources.getString( "moveGroupToTopJMenuItem" ) );
    /**
     *  menu item that allows move up in the list
     *
     **/
    private JMenuItem moveGroupUpJMenuItem = new JMenuItem( Settings.jpoResources.getString( "moveGroupUpJMenuItem" ) );
    /**
     *  menu item that allows move up in the list
     *
     **/
    private JMenuItem moveGroupDownJMenuItem = new JMenuItem( Settings.jpoResources.getString( "moveGroupDownJMenuItem" ) );
    /**
     *  menu item that allows move to top op list
     *
     **/
    private JMenuItem moveGroupToBottomJMenuItem = new JMenuItem( Settings.jpoResources.getString( "moveGroupToBottomJMenuItem" ) );
    /**
     *  menu item that allows indenting the group
     *
     **/
    private JMenuItem indentJMenuItem = new JMenuItem( Settings.jpoResources.getString( "indentJMenuItem" ) );
    /**
     *  menu item that allows outdenting the group
     *
     **/
    private JMenuItem outdentJMenuItem = new JMenuItem( Settings.jpoResources.getString( "outdentJMenuItem" ) );
    /**
     ...
     **/
    public void actionPerformed( ActionEvent e ) {
        if ( e.getSource() == addCollectionFormFile ) {
            caller.requestAddCollection();
