...
/**
 * This request indicates that the user wants to bring up a GUI to pick a flat file and it to the group
 * 
...
public class ChooseAndAddFlatfileRequest implements Request {
    ...
    /**
     * A request to bring up a GUI to add a flatfile of picture filenames to the group
