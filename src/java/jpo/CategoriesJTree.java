...
/*
CategoriesJTree.java:  class that creates a JTree for browsing the images by category

Copyright (C) 2005  Richard Eigenmann.
 ...
 */
public class CategoriesJTree extends JTree 
...
//		new JarDistillerJFrame( popupNode );
	...
	private class MyPopupListener extends MouseAdapter {
		...
		/**
		  *  Registers the CollectionJTree which will receive the events.
		  */
		public void setHandle( CollectionJTree collectionJTree ) {
	...
	class MyTreeModelListener implements TreeModelListener {
		public void treeNodesChanged (TreeModelEvent e) {
			//Tools.log( "CollectionJTree.treeNodesChanged: trapped on " + e.getTreePath() );
		}

	
		public void treeNodesInserted (TreeModelEvent e) {
			//Tools.log ( "CollectionJTree.treeNodesInserted: trapped on " + e.getTreePath() );
		}

		public void treeNodesRemoved (TreeModelEvent e) {
			//Tools.log ( "CollectionJTree.treeNodesRemoved: trapped on " + e.getTreePath() );
		}

		public void treeStructureChanged (TreeModelEvent e) {
			//Tools.log( "CollectionJTree:treeStructureChanged: trapped on " + e.getTreePath() );
		}
	}
