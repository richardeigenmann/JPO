...
/*
 Copyright (C) 2025 Richard Eigenmann, Zurich, Switzerland
...
class ThumbnailCreationQueueTest {
    ...
    void requestThumbnailCreationTest() {
        ...
        final var mtqmyThumbnailQueueRequestCallbackHandlerh = new MyThumbnailQueueRequestCallbackHandler();
        final var node = new SortableDefaultMutableTreeNode();
        ThumbnailCreationQueue.requestThumbnailCreation(new ThumbnailQueueRequest(mtqmyThumbnailQueueRequestCallbackHandlerh, node, QUEUE_PRIORITY.LOW_PRIORITY, new Dimension(350, 350)));
    ...
    void requestThumbnailCreationExistsTest() {
        assertEquals(0, ThumbnailCreationQueue.size());
        final var myThumbnailQueueRequestCallbackHandler = new MyThumbnailQueueRequestCallbackHandler();
        final var node = new SortableDefaultMutableTreeNode();
        ThumbnailCreationQueue.requestThumbnailCreation(new ThumbnailQueueRequest(myThumbnailQueueRequestCallbackHandler, node, QUEUE_PRIORITY.LOW_PRIORITY, new Dimension(350, 350)));
        assertEquals(1, ThumbnailCreationQueue.size());
        ThumbnailCreationQueue.requestThumbnailCreation(new ThumbnailQueueRequest(myThumbnailQueueRequestCallbackHandler, node, QUEUE_PRIORITY.MEDIUM_PRIORITY, new Dimension(350, 350)));
        // Queue should have one entry after-re requesting for the same callback handler
        assertEquals(1, ThumbnailCreationQueue.size());
        final var findResult1 = ThumbnailCreationQueue.findThumbnailQueueRequest(myThumbnailQueueRequestCallbackHandler);
    ...
    void requestThumbnailCreationExistsDifferentTest() {
        ...
        ThumbnailCreationQueue.requestThumbnailCreation(new ThumbnailQueueRequest(myThumbnailQueueRequestCallbackHandler, node, QUEUE_PRIORITY.LOW_PRIORITY, new Dimension(350, 350)));
        assertEquals(1, ThumbnailCreationQueue.size());
        ThumbnailQueueRequest findResult1 = ThumbnailCreationQueue.findThumbnailQueueRequest(myThumbnailQueueRequestCallbackHandler);

        ThumbnailCreationQueue.requestThumbnailCreation(new ThumbnailQueueRequest(myThumbnailQueueRequestCallbackHandler, node, QUEUE_PRIORITY.MEDIUM_PRIORITY, new Dimension(400, 350)));
        assertEquals(1, ThumbnailCreationQueue.size());

        final var findResult2 = ThumbnailCreationQueue.findThumbnailQueueRequest( myThumbnailQueueRequestCallbackHandler );
    ...
    void pollTest() {
        assertEquals(0, ThumbnailCreationQueue.size());
        final var mtqrch1 = new MyThumbnailQueueRequestCallbackHandler();
        final var mtqrch2 = new MyThumbnailQueueRequestCallbackHandler();
        final var node1 = new SortableDefaultMutableTreeNode();
        final var node2 = new SortableDefaultMutableTreeNode();
    ...
    private static class MyThumbnailQueueRequestCallbackHandler implements ThumbnailQueueRequestCallbackHandler {
        ...
        private final ArrayList<ThumbnailQueueRequest> receivedNotifiactions = new ArrayList<>();
