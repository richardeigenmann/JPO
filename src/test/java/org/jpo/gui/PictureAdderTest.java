...
class PictureAdderTest {
    ...
    void testAddingMultiplePictures() {
        ...
        try {
            ...
            final var imageFile2 = new File(ExifInfoTest.class.getClassLoader().getResource(image2).toURI());
            final var imageFile3 = new File(ExifInfoTest.class.getClassLoader().getResource(image3).toURI());
            ...
            SwingUtilities.invokeAndWait(() -> {
                ...
                await()
                        ...
                        .until(new Callable<Boolean>() {
                            @Override
                            public Boolean call() throws Exception {
                                return testNode.getChildCount() > 2;
                            }
                        });
    ...
    void testAddingMSWordDoc() {
        ...
        try {
            ...
            final var imageFile = new File(ExifInfoTest.class.getClassLoader().getResource(msWordDocFile).toURI());
            final File[] files = {imageFile};
            final Collection<Integer> selectedCategories = new ArrayList<Integer>();
            SwingUtilities.invokeAndWait(() -> {
                final PictureAdderRequest request = new PictureAdderRequest(testNode, files, false, true, true, selectedCategories);
    ...
    void testAddingMSWordDocx() {
        ...
        try {
            ...
            final var imageFile = new File(ExifInfoTest.class.getClassLoader().getResource(msWordDocxFile).toURI());
            final File[] files = {imageFile};
            final Collection<Integer> selectedCategories = new ArrayList<Integer>();
            SwingUtilities.invokeAndWait(() -> {
                final PictureAdderRequest request = new PictureAdderRequest(testNode, files, false, true, true, selectedCategories);
    ...
    void testAddingLibreOfficeText() {
        ...
        try {
            ...
            final var imageFile = new File(ExifInfoTest.class.getClassLoader().getResource(libreOfficeOdtFile).toURI());
            final File[] files = {imageFile};
            final Collection<Integer> selectedCategories = new ArrayList<Integer>();
            SwingUtilities.invokeAndWait(() -> {
                final PictureAdderRequest request = new PictureAdderRequest(testNode, files, false, true, true, selectedCategories);
