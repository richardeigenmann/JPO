...
public class CheckIntegrityRequestTest {
     ...
     * Constructor
     */
    public CheckIntegrityRequestTest() {
    ...
    public void testReceivingEvent() {
        ...
        assertEquals( "After firing a CheckIntegrityRequest we expect it to be received by the listener",
     ...
     * Receives the event.
     */
    private CheckIntegrityRequest receivedEvent;
    ...
    private class EventBusSubscriber {
        ...
        @Subscribe
        public void handleCCheckIntegrityRequest( CheckIntegrityRequest event ) {
            receivedEvent = event;
        }
    }
