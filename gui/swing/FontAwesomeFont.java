...
public class FontAwesomeFont {
    ...
    static {
        try (final var regular = FontAwesomeFont.class.getResourceAsStream("/Font Awesome 5 Free-Regular-400.otf");
            ...
            if (regular == null || solid == null) {
                LOGGER.log(Level.SEVERE, "FontAwesome font files not found in resources!");
                fontAwesomeRegular24 = new Font(Font.SANS_SERIF, Font.PLAIN, 24);
                fontAwesomeRegular18 = new Font(Font.SANS_SERIF, Font.PLAIN, 18);
                fontAwesomeSolid24 = new Font(Font.SANS_SERIF, Font.PLAIN, 24);
                return;
            }
            ...
            LOGGER.log(Level.SEVERE, "Could not load FontAwesome font. Falling back to system fonts. Exception: {0}", e.getMessage());
        }
    }
