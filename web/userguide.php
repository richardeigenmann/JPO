    <?php include("page-start.php"); ?>
        <span class="para-heading" id="tutorials">Tutorials</span>
                    <table>
                        <tr>
                            <td>
                                <a href="tutorial_gettingstarted.php">Tutorial 1</a>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <a href="tutorial_download_from_camera.php">Tutorial 2</a>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <a href="tutorial_order_prints.php">Tutorial 3</a>
                            </td>
                            <td>
                    ...
                    <hr>
                    <span class="para-heading">Browsing your picture collection</span>
			...
			Copyright 2007-2016 by Richard Eigenmann, Z&uuml;rich, Switzerland</p>
