...
<div class="container">
    <h2>Developing JPO on Windows</h2>

    <h3>Optional: Install a Windows Virtual Machine</h3>

    <p>If you are mainly on Linux or if you want a clean development machine you can download a temporary Windows 10
    virtual machine image from Microsoft here:
    <a href="https://developer.microsoft.com/en-us/windows/downloads/virtual-machines/">https://developer.microsoft.com/en-us/windows/downloads/virtual-machines/</a></p>
    ...
    <h3>Get the project into IntelliJ</h3>
        ...
        <p>A red exclamation mark will show up on "Event" because git is not found. Click on "Configure...". In the
        field "Path to Git executable" type "C:\Program Files\Git\bin\git.exe" You installed it there in the first step
        above</p>

        <p>Now try to do the cloning again.</p>
