    ...
    <tr>
        ...
        <td>
            ...
            <p>JPO is a program that helps you organise your digital pictures by putting them in
                collections. You can browse, reorganise and find your pictures in the collections.
            ...
            <p>JPO can generate webpages for you and you can use it to tidy up your picture directories.
                It has over 12 years of development in it, runs on any computer that runs Java
            ...
            <ul>
                ...
                <li> Pure Java, no native libraries used </li>
            ...
            <img src="jpo_scr_1.png" width=697 height=510 border=0 alt="Screenshot of JPO">
            <p>The slide show window:</p>
            <img src="jpo_scr_2.jpg" width=659 height=505 border=0 alt="Screenshot of JPO">
            ...
            <hr>
            <h2 id="Techdes">Technical description</h2>
            ...
            <p>Last update to this page: 6.4.2013<br>
